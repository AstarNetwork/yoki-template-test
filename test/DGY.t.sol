...
import {TestMe} from "../src/DGY/TestMe.sol";
import {Config} from "../src/DGY/Config.sol";
...
contract BaseTemplateTest is Test {
    ...
    function setUp() public {
        ...
        */
        testMe = new TestMe(address(this), address(this), address(this), "NAME", "SYMBOL", 8888, 8, "ipfs");
        config = new Config();
