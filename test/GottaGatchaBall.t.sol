...
import {TestMe} from "../src/NFTTrader-GottaGachaBall/TestMe.sol";
import {Config} from "../src/NFTTrader-GottaGachaBall/Config.sol";
...
contract BaseTemplateTest is Test {
    ...
    function setUp() public {
        ...
        */
        testMe = new TestMe(address(this), address(this), 40000);
        config = new Config();

        vm.deal(address(this), 100 ether);

        testMe.toggleAllowPublicMint();
    }
