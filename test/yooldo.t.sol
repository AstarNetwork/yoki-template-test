...
import {TestMe} from "../src/yooldo/TestMe.sol";
import {FeeRecipient} from "../src/yooldo/FeeRecipient.sol";
import {Config} from "../src/yooldo/Config.sol";
...
contract BaseTemplateTest is Test {
    ...
    function setUp() public {
        ...
        */
        testMe = new TestMe("NAME", "SYMBOL", "ipfs://example.com/");
        config = new Config();
        feeRecipient = new FeeRecipient();

        testMe.updateDetails(payable(address(feeRecipient)), 7500000000000000, address(this));
